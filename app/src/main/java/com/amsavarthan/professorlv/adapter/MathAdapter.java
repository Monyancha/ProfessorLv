...
import com.amsavarthan.professorlv.activities.MathContainer;
import com.amsavarthan.professorlv.models.Functions;
...
public class MathAdapter extends RecyclerView.Adapter<MathAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.functions_card,parent,false));
    }
