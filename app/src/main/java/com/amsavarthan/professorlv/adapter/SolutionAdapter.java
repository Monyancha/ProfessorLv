...
public class SolutionAdapter  extends RecyclerView.Adapter<SolutionAdapter.SolutionViewHolder> {
    ...
    @NonNull
    @Override
    public SolutionAdapter.SolutionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SolutionAdapter.SolutionViewHolder holder, int position) {
