...
import com.amsavarthan.professorlv.activities.Preview;
...
public class SolutionStateResultAdapter extends RecyclerView.Adapter<SolutionStateResultAdapter.SolutionViewHolder> {
    ...
    @NonNull
    @Override
    public SolutionStateResultAdapter.SolutionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SolutionStateResultAdapter.SolutionViewHolder holder, int position) {
