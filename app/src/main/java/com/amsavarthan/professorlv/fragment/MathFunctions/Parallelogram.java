package com.amsavarthan.professorlv.fragment.MathFunctions;
...
import com.amsavarthan.professorlv.utils.FormulaUtils;
...
public class Parallelogram extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.parallelogram_frag, container, false);
    }
