package com.amsavarthan.professorlv.utils;
...
public class Utils {
    ...
    public static final String PACKAGE_NAME = "com.amsavarthan.professorlv";
    public static final String TESS_DATA_PATH = Environment.getExternalStorageDirectory().toString() + "/Professor Lv/";
