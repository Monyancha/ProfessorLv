package com.amsavarthan.professorlv.OCR;
...
import static com.amsavarthan.professorlv.utils.Utils.TESS_DATA_PATH;
import static com.amsavarthan.professorlv.utils.Utils.tess_lang;
...
public class TessOCR {
    ...
    public TessOCR(AssetManager assetManager) {
        ...
        Log.i(TAG, TESS_DATA_PATH);

        this.assetManager = assetManager;

        String[] paths = new String[] { TESS_DATA_PATH, TESS_DATA_PATH + "tessdata/" };
        ...
        if (!(new File(TESS_DATA_PATH + "tessdata/" + tess_lang + ".traineddata")).exists()) {
            try {
                InputStream in = assetManager.open("tessdata/" + tess_lang + ".traineddata");
                OutputStream out = new FileOutputStream(new File(TESS_DATA_PATH + "tessdata/", tess_lang + ".traineddata"));
        ...
        mTess.setDebug(true);
        mTess.init(TESS_DATA_PATH, tess_lang);
