...
import com.amsavarthan.professorlv.adapter.SolutionAdapter;
    ...
    private class SearchTask extends AsyncTask<String, Void, ArrayList<Solution>> {
        ...
        protected void onPostExecute(ArrayList<Solution> solutions) {
            ...
            if (solutions != null && solutions.size() > 0) {
                ...
                Utils.showMultiLineSnackBar(layout, "Sorry i don't know about that, But you can ask it to a other users worldwide", "Ask", new View.OnClickListener() {
                    @Override
